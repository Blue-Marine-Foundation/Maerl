  ...
  return (
    <div className='max-w-6xl mx-auto'>
      <h2 className='text-2xl font-bold mb-8'>
        Admin panel{' '}
        <span className='pl-3 text-base font-normal text-foreground/70'>
          Coming soon...
        </span>
      </h2>
      <div className='w-full p-8 border rounded-lg min-h-[300px] flex flex-col justify-center items-center bg-gray-100 text-gray-500 text-sm dark:bg-gray-800 dark:text-slate-300'>
        It's better to be at the bottom of a ladder that you want to climb than
        halfway up one you don't
      </div>
    </div>
  );
}
