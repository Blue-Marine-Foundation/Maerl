      ...
      <div className={cn('grid gap-2', className)}>
        ...
        >
          ...
          <button
            ...
            className='h-10 w-32 rounded-r-md border border-l-0 bg-background text-center text-sm hover:bg-accent disabled:bg-transparent disabled:text-foreground/40'
          >
            {isUpdating ? (
